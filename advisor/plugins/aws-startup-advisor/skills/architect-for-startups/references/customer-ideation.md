...
### The 5 Questions That Actually Matter for Startup Architecture
...
3. **Do you have AWS credits? How much, when do they expire?** (Changes every capacity planning decision)
4. **What's your current traffic/data volume, and what's your 12-month optimistic projection?** (Design for 10x current, have a PATH to 100x)
5. **What's the one thing that, if it breaks, kills your company?** (This is what gets redundancy. Everything else gets the cheapest option)
...
- Ask: "Are cold starts acceptable for your use case?" (determines Lambda vs App Runner)

**If team = 1-2 engineers:**

- Eliminate: EKS, self-managed databases, custom networking
- Ask: "Do you have container experience, or is deploying a zip file more natural?"
