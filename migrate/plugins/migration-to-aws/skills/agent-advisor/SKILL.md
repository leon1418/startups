...
| `references/phases/migration-plan/migration-plan.md`                 | Stage 2: full migration plan via the sibling gcp-to-aws or fly-to-aws engine |
| `references/phases/migration-plan/migration-plan-fly-constraints.md` | fly-to-aws global constraints for inline execution                           |
