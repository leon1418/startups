...
- AgentCore session cap (now split: 8h for default serverless microVM runtime; up to 14 days for EC2-backed runtime instances) — resolved, no longer pending verification
