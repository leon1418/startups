...
- Session cap: 8h (max 28,800s) — same as AgentCore's default microVM runtime; AgentCore runtime instances now support up to 14 days, making Lambda MicroVMs' cap shorter than AgentCore's maximum
