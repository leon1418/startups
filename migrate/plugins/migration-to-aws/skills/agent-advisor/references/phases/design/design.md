...
_preconditions:
  - _check_phase_completed: clarify-pass2
    _on_failure: _halt_and_inform
  - _check_file_exists: [scoring-result.json, pass2.json]
    _on_failure: _unrecoverable
  - _validate_json: [scoring-result.json, pass2.json]
    _on_failure: _unrecoverable
_postconditions:
